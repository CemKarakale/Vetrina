...
""")
    ...
    for idx, row in df_prod.iterrows():
        ...
        append_sql(f"INSERT INTO Products (id, store_id, category_id, sku, name, description, unit_price) VALUES ({prod_id_counter}, {st_id}, {c_id}, '{sku}', {escape_str(p_name)}, {escape_str(p_desc)}, {price:.2f});")
        products_db.append({'id': prod_id_counter, 'store_id': st_id, 'price': price})
        prod_id_counter += 1
