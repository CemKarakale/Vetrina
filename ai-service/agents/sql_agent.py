...
- products (id, store_id, name, category_id, unit_price, stock_quantity)
...
ÖNEMLİ: order tablosunda "total_amount" YOK, "grand_total" KULLAN!
ÖNEMLİ: stores tablosunda "user_id" YOK, "owner_id" KULLAN!
"""
